    ...
    <main class="l-main">
        ...
        <section class="p-article--text">
            <div class="l-container section-fadein">
                <h2 class="c-title">おデブさんのダイエット法</h2>
                <p class="c-heading">
                    blender（モデリングとアニメーション）/Makehuman/Premierによる3DCG動画制作（学生作品）
                </p>
                <p class="c-heading">挿入曲</p>
                <ul class="p-article--list">
                    <li>Take A Hint : Victorious Cast feat. Victoria Justice & Elizabeth Gillies</li>
                </ul>
