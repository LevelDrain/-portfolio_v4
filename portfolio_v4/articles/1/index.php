        ...
        <section class="p-article--text">
            <div class="l-container section-fadein">
                ...
                <div class="l-container section-fadein">
                    ...
                    <p class="c-heading">
                        Webページの制作、バナー発注、コピーライティング、SNS告知など全てのフロントエンドおよびデザイン企画業務を担当していた。<br>
                    ...
                    <p class="c-heading">内部Webページの例。HTML/CSSは全て独学で何とか形にする。</p>
                    <div class="p-article--fig">
                        <img src="../img/colombo_pu2.png" alt="">
                    </div>
                </div>
                ...
                <div class="l-container section-fadein">
                    ...
                    <p class="c-heading">
                        社内・社外問わず、キャラクター名や設定、武器、装備品などの企画書を作成していた（費用面は担当しない）。<br>
                        下記は担当したキャラクターの一例。「お色気もの」がメインのテーマだったため、露出が多いキャラクターについての規制などを考慮しつつ慎重に企画していた。<br>
                        画像はキャラクター発注からバナー企画書、キャッチコピー、キャラクター名およびスキル名考案までを全面担当したもの。
                    </p>
                    <div class="p-article--fig">
                        <img src="../img/colombo_pu2.png" alt="">
                    </div>
